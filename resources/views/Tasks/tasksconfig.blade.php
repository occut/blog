...
<a href="{{route('configCreate')}}" class="layui-btn" ><i class="layui-icon">&#xe608;</i>添加</a>
        ...
        @foreach ($result as $v)
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a class="layui-btn layui-btn-small" href="configEdit/{{$v->config_id}}">编辑</a>
                    <a title="删除" class="layui-btn layui-btn-small" href="javascript:;" onclick="del(this,'{{$v->config_id}}','configdestroy')" style="text-decoration:none">
                        删除
                    </a>
                </td>
            </tr>
