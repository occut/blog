...
<p>
<blockquote class="layui-elem-quote">编辑任务</blockquote>
</p>
...
<div class="layui-tab-item layui-show">
    <form class="layui-form" action="{{route("contentEdit")}}" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="content_number" value="{{$content->content_number}}"  lay-verify="required" placeholder="请输入下单量"  autocomplete="off" class="layui-input" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">任务状态</label>
            <div class="layui-input-block">
                <input type="radio" name="content_status" value="0" title="开启" @if ($content->content_status == 0)checked @endif>
                <input type="radio" name="content_status" value="1" title="关闭" @if ($content->content_status == 1)checked @endif>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
...
//        alert(123);
        ...
        $.ajax({
            ...
            type:"post",
            dataType: "json",
            data:{'configId': firstNavId ,'id': id},
