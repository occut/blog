        ...
        @foreach ($result as $v)
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a class="layui-btn layui-btn-small" href="{{route('tasksedit',['tasks_id'=>$v['tasks_id']])}}">编辑</a>
                    <a title="删除" class="layui-btn layui-btn-small" href="javascript:;" onclick="del(this,'{{$v->tasks_id}}','tasksDel')" style="text-decoration:none">
                        删除
                    </a>
                </td>
            </tr>
