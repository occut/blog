...
<head>
    ...
    <title>后台管理</title>
    <link rel='Shortcut Icon' type='image/x-icon' href='/public/admin/win/img/windows.ico'>
    <script type="text/javascript" src="/public/admin/win/js/jquery-2.2.4.min.js"></script>
    <link href="/public/admin/win/css/animate.css" rel="stylesheet">
    <script type="text/javascript" src="/public/admin/win/component/layer-v3.0.3/layer/layer.js"></script>
    <link rel="stylesheet" href="/public/admin/win/component/font-awesome-4.7.0/css/font-awesome.min.css">
    <link href="/public/admin/win/css/default.css" rel="stylesheet">
    <script type="text/javascript" src="public/admin/win/js/win10.js"></script>
    <style>
        * {
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:'/public/admin/win/img/wallpapers/main.jpg',
                mobile:'/public/admin/win/img/wallpapers/mobile.jpg',
            });
...
//            setTimeout(function () {
//                Win10.openUrl('//win10ui.yuri2.cn/src/broadcast.html','最新资讯',[['300px', '380px'],'rt'])
//            },2000);
        });
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <div class="shortcut" onclick="Win10.openUrl('{{route('userindex')}}','<img class=\'icon\' src=\'/public/admin/win/Icon/8.ico\'/>管理员管理')">
                <img class="icon" src="/public/admin/win/Icon/8.ico"/>
                <div class="title">会员管理</div>
            </div>
            <div class="shortcut" onclick="Win10.openUrl('http://win10ui.yuri2.cn','<img class=\'icon\' src=\'./img/icon/win10.png\'/>Win10-UI官网')">
                <img class="icon" src="/public/admin/win/img/icon/win10.png"/>
            ...
            <div class="shortcut" onclick="Win10.openUrl('https://yuri2.cn','<img class=\'icon\' src=\'./img/icon/blogger.png\'/>尤里2号的博客')">
                <img class="icon" src="/public/admin/win/img/icon/blogger.png"/>
            ...
            <div class="shortcut" onclick="Win10.openUrl('win10ui.yuri2.cn/src/doc.php','<img class=\'icon\' src=\'./img/icon/doc.png\'/>在线文档')">
                <img class="icon" src="/public/admin/win/img/icon/doc.png"/>
                <div class="title">在线文档</div>
            </div>
            <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui')">
                <img class="icon" src="/public/admin/win/img/icon/github.png"/>
            ...
            <div class="shortcut" onclick="Win10.openUrl('https://www.oschina.net/p/win10-ui','<img class=\'icon\' src=\'./img/icon/kyzg.png\'/>开源中国（求支持~）')">
                <img class="icon" src="/public/admin/win/img/icon/kyzg.png"/>
                <div class="title">开源中国</div>
            </div>
            <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui/archive/master.zip')">
                <img class="icon" src="/public/admin/win/img/icon/download.png"/>
                <div class="title">快速获取</div>
            </div>
            {{--<div class="shortcut" ondblclick='Win10.openUrl("/public/admin/win/login.html","<i class=\"fa fa-user icon black-green\"></i>示例登录页")'>--}}
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="item" onclick="layer.open({
                ...
                offset:'100px',
                shadeClose:true,
                content: '<img width=\'300\' src=\'/public/admin/win/img/presentation/donation.jpg\' />'
        ...
        <div class="blocks">
            <div class="menu_group">
                ...
                <div loc="1,1" size="6,3" class="block">
                    ...
                    <div class="content red cover">
                        <img width="264" style="position: relative;top: -50px;" src="/public/admin/win/img/presentation/wangyiyun.gif" />
                    </div>
                </div>
            ...
            <div class="menu_group">
                ...
                <div loc="5,2" size="2,2" class="block">
                    <div class="content">
                        <img style="width: 40px;height: 40px;margin: 5px auto;display: block" src="/public/admin/win/img/icon/baidu.png">
